...
public class TestQuery
{
    ...
    public void C_ShowQueryStatsSchema(SqlServerRef server)
    {
        ...
        Console.WriteLine((object)schema);
    ...
    public void D_QueryQueryCache(SqlServerRef server)
    {
        ...
        var rows = Enumerable.ToList(reader.Read());
        ...
        Console.WriteLine((string)firstForDebug.ToJsonString());
    ...
    public void E_Produce_Html_Report(SqlServerRef server)
    {
        ...
        Console.WriteLine((string)sqlSysInfo.Format("   "));
        ...
        Console.WriteLine((string)e.GetLogsAsString());
    ...
    public void E2_ShowMetricsRange(SqlServerRef server)
    {
        ...
        report.AppendLine($"Queries: {Enumerable.Count(e.Rows)}");
        ...
        foreach (var pi in properties)
        {
            ...
            var longs = rows.Select(x => getProperty(x)).ToArray<long>();
            if (longs.Length > 0)
            {
    ...
    public void F_Get_SQL_OS_Sys_Info(SqlServerRef server)
    {
        ...
        Console.WriteLine((string)osSysInfoRaw.ToJsonString());
    ...
    public void G_TryQueryStatsV4(SqlServerRef server)
    {
        ...
        Console.WriteLine((string)queryCacheQueryV4.GetSqlQuery());
    }
